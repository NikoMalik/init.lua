...
function M.setup()
	...
	vim.api.nvim_set_hl(0, '@variable.builtin', { fg = '{{colors.primary.default.hex}}', italic = true })
	vim.api.nvim_set_hl(0, '@variable.parameter', { fg = '{{colors.on_surface.default.hex}}' })
	vim.api.nvim_set_hl(0, '@variable.member', { fg = '{{colors.on_surface.default.hex}}' })

	-- Fix namespace/module colors (imports like stdx in Zig)
	vim.api.nvim_set_hl(0, '@namespace', { fg = '{{colors.primary.default.hex}}' })
	vim.api.nvim_set_hl(0, '@module', { fg = '{{colors.primary.default.hex}}' })
	vim.api.nvim_set_hl(0, 'TSNamespace', { fg = '{{colors.primary.default.hex}}' })

	-- Fix type and constant colors (better contrast)
	vim.api.nvim_set_hl(0, 'Type', { fg = '{{colors.secondary.default.hex}}' })
	vim.api.nvim_set_hl(0, '@type', { fg = '{{colors.secondary.default.hex}}' })
	vim.api.nvim_set_hl(0, '@type.builtin', { fg = '{{colors.secondary.default.hex}}', italic = true })
	vim.api.nvim_set_hl(0, 'TSType', { fg = '{{colors.secondary.default.hex}}' })
	vim.api.nvim_set_hl(0, 'Constant', { fg = '{{colors.tertiary.default.hex}}' })
	vim.api.nvim_set_hl(0, '@constant', { fg = '{{colors.tertiary.default.hex}}' })
	vim.api.nvim_set_hl(0, '@constant.builtin', { fg = '{{colors.tertiary.default.hex}}', italic = true })
	vim.api.nvim_set_hl(0, 'TSConstant', { fg = '{{colors.tertiary.default.hex}}' })
